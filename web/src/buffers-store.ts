 ...
 * `applyLayout` — ending in `persist()`, which writes the workspace — once per gesture, and
 * every other layout change (a split, a close, a rebind, `reset preset`) reaches the same writer just
