...
credentials.** Re-measured 2026-08-21, unchanged from what the sibling READMEs record:
...
[[grammar]]
name = "redextape_tm"
source = { git = "https://git.daveynet.xyz/davey/redextape", rev = "<commit sha>", subpath = "grammars/tree-sitter-redextape-tm" }
